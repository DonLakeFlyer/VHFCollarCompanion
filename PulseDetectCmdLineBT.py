...
# Generated: Tue Dec 25 14:08:19 2018
##################################################
...
class PulseDetectCmdLineBT(gr.top_block):
    ...
    def __init__(self, channel_index=0, pulse_freq=146e6, samp_rate=3e6, vga_gain=15):
        ...
        self.blocks_vector_sink_x_1_0 = blocks.vector_sink_f(1)
        ...
        self.connect((self.VHFPulseDetect_pulse_detect__ff_0, 2), (self.blocks_vector_sink_x_1_0, 0))    
        self.connect((self.VHFPulseDetect_pulse_detect__ff_0, 3), (self.blocks_vector_sink_x_1_1, 0))    
        self.connect((self.VHFPulseDetect_pulse_detect__ff_0, 4), (self.blocks_vector_sink_x_1_2, 0))    
        self.connect((self.VHFPulseDetect_pulse_detect__ff_0, 5), (self.blocks_vector_sink_x_1_3, 0))    
...
def main(top_block_cls=PulseDetectCmdLineBT, options=None):
    ...
    tb = top_block_cls(channel_index=options.channel_index, pulse_freq=options.pulse_freq, samp_rate=options.samp_rate, vga_gain=options.vga_gain)
    tb.start()
    try:
